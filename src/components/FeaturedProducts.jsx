    ...
    return (
        <section className="min-h-screen flex flex-col justify-center relative overflow-hidden  gap-8">
            ...
            <div className="flex flex-col md:flex-row gap-8 justify-center items-center z-50">
                <BuyCard title="1 Week" price="13,99" features={features} btnText='BUY NOW' className="w-[22rem] z-50" />
                <BuyCard title="1 Month" price="39,99" features={features} btnText='BUY NOW' isSpecial={true} className="w-[22rem] md:w-[25rem] z-50" />
                <BuyCard title="1 Year" price="129,99" features={features} btnText='BUY NOW' className="w-[22rem] z-50" />
            </div>
